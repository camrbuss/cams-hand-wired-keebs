...
mod app {
    ...
    struct Shared {
        ...
        usb_class: UsbClass,
        #[lock_free]
        layout: Layout<12, 5, 5, CustomActions>,
    }

    #[local]
    struct Local {
        matrix: Matrix<ErasedPin<Input<PullUp>>, ErasedPin<Output<PushPull>>, 12, 5>,
    ...
    #[task(binds = TIM3, priority = 1, shared = [usb_class, layout], local = [matrix, debouncer, timer, watchdog])]
